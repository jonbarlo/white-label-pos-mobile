...
// in white_label_pos_mobile/test/unit/features/waiter/table_provider_test.dart.
...
import 'package:white_label_pos_mobile/src/features/waiter/models/table.dart'
    as _i3;
...
class _FakeTable_1 extends _i1.SmartFake implements _i3.Table {
  _FakeTable_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockTableRepository extends _i1.Mock implements _i4.TableRepository {
  MockTableRepository() {
  ...
  @override
  _i5.Future<_i3.Table> getTable(int? tableId) => (super.noSuchMethod(
        Invocation.method(
          #getTable,
          [tableId],
        ),
        returnValue: _i5.Future<_i3.Table>.value(_FakeTable_1(
          this,
          Invocation.method(
            #getTable,
            [tableId],
      ...
      ) as _i5.Future<_i3.Table>);

  @override
  _i5.Future<_i3.Table> updateTableStatus(
    int? tableId,
  ...
  @override
  _i5.Future<_i3.Table> assignTable(
    int? tableId,
    int? waiterId,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<void> clearTable(int? tableId) => (super.noSuchMethod(
        Invocation.method(
          #clearTable,
          [tableId],
        ),
