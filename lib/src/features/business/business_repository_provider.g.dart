...
String _$businessRepositoryHash() =>
    r'd23573fb729b98ba52565fe100219e5d6d7721c9';

/// See also [businessRepository].
@ProviderFor(businessRepository)
final businessRepositoryProvider =
    AutoDisposeFutureProvider<BusinessRepository>.internal(
  businessRepository,
...
typedef BusinessRepositoryRef
    = AutoDisposeFutureProviderRef<BusinessRepository>;
